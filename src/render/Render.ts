...
import { loadObject } from "../loadObjects/LoadObject";
...
export default async function render(p5: P5CanvasInstance) {
  p5.setup = () => {
    p5.createCanvas(WIDTH, HEIGHT);
    p5.noStroke();
  };

  const object: BYUObject = await loadObject("maca2.byu");
