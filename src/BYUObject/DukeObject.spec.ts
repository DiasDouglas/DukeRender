...
describe("BYUObject", () => {
    ...
    describe("setVertices", () => {
        it("sets the vertices of the object", () => {
            object.setVertices([[1, 2, 3], [4, 5, 6], [7, 8, 9]]);
            expect(object.getVertices()).toEqual([[1, 2, 3], [4, 5, 6], [7, 8, 9]]);
        });
    });
    ...
    describe("setIndexes", () => {
        it("sets the indexes of the object", () => {
            object.setIndexes([[1, 2, 3], [4, 5, 6], [7, 8, 9]]);
            expect(object.getIndexes()).toEqual([[1, 2, 3], [4, 5, 6], [7, 8, 9]]);
        });
    });
});